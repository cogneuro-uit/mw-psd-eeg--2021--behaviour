...
@tbl-pre-pos-across-sleep-vars to @tbl-change-across-sleep-vars indicate all bayesian models for the affect as the outcome using various PSD predictor treatments (strict compliance vs. dose-response) as well as types (actigraphy, self-report and the adjusted PSD). Bold rows indicate a significant (*p*~dir~ >= .95) difference from the adjusted PSD.
